...
public class LockingConflictException extends RuntimeException implements ExceptionInterface {

  private final ErrorCode code = ErrorCode.LOCKING_CONFLICT_ERROR_CODE;
