...
public final class CommonUtils {
  ...
  public static final String CDN_DEV = "https://cdn-dev.lacafe.uz";
  public static final String CDN = "https://cdn.lacafe.uz";
  ...
  public static String getImageUrl(final String buildType, final String url) {
  ...
  public static String requireValidEmail(String email) {
    ...
    if (!validateEmail(email)) {
      throw new InvalidArgumentException(
          ErrorCode.INVALID_ARGUMENT_ERROR_CODE, String.format("[%s] email is invalid", email));
    }
